...
@section('title', 'Day10 - Teknik presentasi produk')

@section('judul', 'Teknik presentasi produk')

@section('prevRoute', '/day10/a1')

@section('nextRoute', '/day10/a3')
...
@section('materi')
  <a href="{{ route('day10.a1') }}" class="text-white border-bottom">
  ...
  <a href="{{ route('day10.a3') }}" class="text-white border-bottom">
