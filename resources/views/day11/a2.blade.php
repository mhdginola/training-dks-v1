...
@section('title', 'Day11 - Service excellent')

@section('judul', 'Service excellent')

@section('prevRoute', '/day11/a1')

@section('nextRoute', '/day11/a3')
...
@section('materi')
  <a href="{{ route('day11.a1') }}" class="text-white border-bottom">
  ...
  <a href="{{ route('day11.a3') }}" class="text-white border-bottom">
    <li class="list-group-item border-0">Perhitungan-perhitungan</li>
  </a>
  <a href="{{ route('day11.a4') }}" class="text-white border-bottom">
    <li class="list-group-item border-0">Spesifikasi hardware berdasarkan material</li>
  </a>
  <a href="{{ route('day11.a5') }}" class="text-white border-bottom">
